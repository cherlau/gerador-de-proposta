  ...
  <div >
    <div id="container">
      <div class="content">
        ...
        <input-range :tipo="'CRM (reservas)'"></input-range>
        <input-range :tipo="'Espelho de Vendas - Gestão de Unidades e Tabelas'"></input-range>
        <input-range :tipo="'Usuários Ativos'"></input-range>
        <input-range :tipo="'API Pública'"></input-range> 
      </div>
...
export default {
  name: 'GestaoEmpreendimentos',
  data: () => ({
    moduloClicado: 'gestao_de_produtos',
  }),
  setup() {
    const gestaoTipo = 'gestao_de_empreendimentos'
